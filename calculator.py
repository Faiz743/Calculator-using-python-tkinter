...
def equalpress():
    # Try and except statement is used for 
    # handling the errors like zero division error etc.
    try:

        global expression

        # eval function evaluate the expression and 
        # str function convert the result into string
...
if __name__ == "__main__":
    ...
    # when user press the button, the command will be executed
